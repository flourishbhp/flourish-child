...
@tag('screening3')
class TestDevScreening3Months(TestCase):
    ...
    def setUp(self):
        ...
        self.maternal_dataset_options = {
            'delivdt': get_utcnow() - relativedelta(years=1, months=3),
            'mom_enrolldate': get_utcnow(),
            'mom_hivstatus': 'HIV-infected',
            'study_maternal_identifier': '12345',
            'protocol': 'Tshilo Dikotla'
        ...
        self.child_birth_options = {
            ...
            'first_name': 'TR',
            'initials': 'TT',
            'dob': get_utcnow() - relativedelta(years=1, months=3),
            'gender': MALE

            }

    @tag('screening3')
    def test_dev_screening_12_months(self):
        maternal_dataset_obj = mommy.make_recipe(
            'flourish_caregiver.maternaldataset',
            **self.maternal_dataset_options)
        ...
        visit = ChildVisit.objects.get(visit_code='2001')
        mommy.make_recipe(
            'flourish_child.infantdevscreening12months',
            child_visit=visit,
            )
