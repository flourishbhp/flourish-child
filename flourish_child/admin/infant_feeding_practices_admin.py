...
from ..forms import InfantFeedingPracticesForm
from ..models import InfantFeedingPractices
from .model_admin_mixins import ChildCrfModelAdminMixin


@admin.register(InfantFeedingPractices, site=flourish_child_admin)
class InfantFeedingPracticesAdmin(ChildCrfModelAdminMixin, admin.ModelAdmin):

    form = InfantFeedingPracticesForm
    fieldsets = (
        (None, {
            'fields': [
                "child_visit",
