...
class ChildSocioDemographicAdmin(ChildCrfModelAdminMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': [
                ...
                'stay_with_caregiver',
                'primary_caretaker',
                'primary_caretaker_other',
                'secondary_caretaker',
                'secondary_caretaker_other',
                'water_source',
                'house_electrified',
                'house_fridge',
                'cooking_method',
    ...
    radio_fields = {'ethnicity': admin.VERTICAL,
                    ...
                    'busy_road_before': admin.VERTICAL,
                    'near_busy_road': admin.VERTICAL,
                    'building_date': admin.VERTICAL,
                    'paint_peeling': admin.VERTICAL,
                    'house_painted': admin.VERTICAL,
                    'secondary_caretaker': admin.VERTICAL,
                    'primary_caretaker': admin.VERTICAL,
    ...
    custom_form_labels = [
        FormLabel(
            ...
            label=(
                'Since the last time you spoke to a FLOURISH study member, has any of '
                'your'
