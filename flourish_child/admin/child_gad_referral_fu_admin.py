...
from ..forms import ChildGadReferralFUForm
from ..models import ChildGadReferralFU
from .model_admin_mixins import ChildCrfModelAdminMixin


@admin.register(ChildGadReferralFU, site=flourish_child_admin)
class ChildGadReferralFUAdmin(ChildCrfModelAdminMixin, admin.ModelAdmin):

    form = ChildGadReferralFUForm
