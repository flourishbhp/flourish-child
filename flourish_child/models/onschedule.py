...
class OnScheduleChildCohortAInPerson(OnScheduleModelMixin):
    pass
...
class OnScheduleChildCohortBInPerson(OnScheduleModelMixin):
    pass
...
class OnScheduleChildCohortCInPerson(OnScheduleModelMixin):
    pass
