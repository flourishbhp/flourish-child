...
from flourish_child.choices import NOT_TESTED_REASON, POS_NEG_PENDING_UNKNOWN, \
    PREFERRED_CLINIC
...
class HivTestingModelMixin(models.Model):
    ...
    preferred_clinic_for_testing = models.CharField(
        verbose_name='If Q3 is No, Do you prefer to go to the local clinic or to come '
    ...
    additional_comments = models.TextField(
        ...
        null=True,
        blank=True,
        help_text='If answer to Q13 is “I do not wish to have my infant tested at this '
                  'time” or “Other”, '
